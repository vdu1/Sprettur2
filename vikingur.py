...
#Grabbing objectsHlutir sem notendur geta notfært sér
snooz = 0
flower = 0
...
def inngangur():
  ...
  " næturvakt í VR-II. Þegar Víkingur sér hvað þetta er létt námsefni þá...\n")
  time.sleep(3)
  print ("""  A. Sleppir því að stilla vekjaraklukku
  B. Fer að spila Fifa
...
def prof():
  time.sleep(3)
  print ("\nGlæsilegt þú gast ekki klúðrað þessari spurningu því Stægrein II var svo létt fyrir Víking. Nú er Víkingur mættur í prófið...\n")
  time.sleep(3)
...
def matur():
  ...
  " á Stúdentakjallarann. Hvað fær Víkingur sér að borða?\n")
  time.sleep(3)
...
def logn():
  ...
  " Ýtir Víkingur á snooze. Já eða nei?")
  time.sleep(3)
  choice = input("\n>>> ")
  if choice in yes:
    snooz = 1 #Snoozar
  ...
  if choice in answer_A:
      if snooz > 0:
          ...
          " og í þetta sinn sá svefninn til þess að Víkingur útskrifast ekki úr háskólanum!")
  elif choice in answer_B:
...
def lokaprof():
  ...
  if choice in answer_A:
    ...
    print ("Víkinur er frábær í Autocad og rúllar prófinu upp. "
    "\nTil hamingju, þú náðir að útskrifa Víking Goða!")
  else:
    print (rettinntak)
    lokaprof()
